...
Source0  : https://download.savannah.gnu.org/releases/quilt/quilt-0.68.tar.gz
Source1  : https://download.savannah.gnu.org/releases/quilt/quilt-0.68.tar.gz.sig
...
%setup -q -n quilt-0.68
cd %{_builddir}/quilt-0.68
pushd ..
cp -a quilt-0.68 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720037302
